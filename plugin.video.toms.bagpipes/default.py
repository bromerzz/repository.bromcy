...
def Main_Menu():
    ...
    Add_Dir(name="Regimental Bands Pipes and Drums", url=' ', mode="regimental_bands_pipes_and_drums_menu", folder=True,)
...
@route(mode='regimental_bands_pipes_and_drums_menu')
def Regimental_Bands_Pipes_And_Drums_Menu():
